...
chrome.tabs.onRemoved.addListener(function(tabId, removeInfo){
    ...
    if(currentBrowserState["windows"].hasOwnProperty("window"+removeInfo.windowId)){
...
chrome.tabs.onActivated.addListener(function(activeInfo){
    if(currentBrowserState["windows"].hasOwnProperty("window"+activeInfo.windowId)){
...
chrome.tabs.onMoved.addListener(function(tabId, moveInfo){
    if(currentBrowserState["windows"].hasOwnProperty("window"+moveInfo.windowId)){
...
chrome.tabs.onDetached.addListener(function(tabId, detachInfo){
    if(currentBrowserState["windows"].hasOwnProperty("window"+detachInfo.oldWindowId)){
